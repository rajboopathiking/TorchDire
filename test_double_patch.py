...
# Patch once
patch_llama_with_qgfd(model, diffusion_steps=2, target_alpha=0.02, warmup_steps=0)

# Patch twice
patch_llama_with_qgfd(model, diffusion_steps=2, target_alpha=0.02, warmup_steps=0)

out_cache = model.generate(**inputs, max_new_tokens=50, do_sample=False, use_cache=True)
